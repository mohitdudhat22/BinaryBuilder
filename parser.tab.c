...
static const char *const yytname[] =
{
  ...
  "MINUS", "MUL", "DIV", "LPAREN", "RPAREN", "$accept", "expr", "term",
  "factor", YY_NULLPTR
};
...
{
       6,     8,     9,     1,    15,    16,    13,    14,     2,    10,
      11,     7,     0,    12
};

static const yytype_int8 yycheck[] =
{
       2,     4,     5,     3,    10,    11,     8,     9,     8,     6,
       7,     0,    -1,     9
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* expr: term PLUS expr  */
#line 17 "parser.y"
                          { printf(" +"); }
#line 1073 "parser.tab.c"
    break;

  case 4: /* expr: term MINUS expr  */
#line 18 "parser.y"
                          { printf(" -"); }
#line 1079 "parser.tab.c"
    break;

  case 6: /* term: factor MUL term  */
#line 22 "parser.y"
                          { printf(" *"); }
